...
enum ChatMsg
{
    ...
    CHAT_MSG_RAID_BOSS_EMOTE        = 0x5A, // 0x5A et non 0x2A (Elysium)
...
#define EXPECTED_MANGOSD_CLIENT_BUILD        {5595,5875,6005, 0}
