/*
Elysium custom header.
Used for :
- Configuration defines
*/
//#define CONFIG_ELYSIUM_MAX 3

#ifndef ELYSIUM_HEADER
#define ELYSIUM_HEADER
...
enum customFlag
{
    ...
    CUSTOM_FLAG_FROM_ELYSIUM   = 0x0010,
    CUSTOM_FLAG_FROM_BLACKROCK    = 0x0020,
    CUSTOM_FLAG_FROM_ELYSIUM_2 = 0x0040,
    CUSTOM_FLAG_FROM_PRISMATIA    = 0x0080,
    CUSTOM_FLAG_FROM_ELYSIUM_3 = 0x0100,

    CUSTOM_FLAG_PRISMATIA_BETA    = 0x0200,
    CUSTOM_FLAG_FIRST_GAMEPLAY    = CUSTOM_FLAG_IN_PEX,
    CUSTOM_FLAG_LAST_GAMEPLAY     = CUSTOM_FLAG_HL,
    CUSTOM_FLAG_FIRST_ORIGIN      = CUSTOM_FLAG_FROM_ELYSIUM,
    CUSTOM_FLAG_LAST_ORIGIN       = CUSTOM_FLAG_FROM_ELYSIUM_3,
};
